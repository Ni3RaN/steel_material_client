<template>
  <div>
    <el-breadcrumb separator-icon="ArrowRight">
      ...
      <el-breadcrumb-item>查看历史数据</el-breadcrumb-item>
    </el-breadcrumb>
    <el-divider />
...
export default {
  ...
  methods: {
    async getTotal(){
      let total;
      let url = 'http://' + document.location.hostname + ':8081/get_rolled_steel_train/getPage';
    ...
    async getData() {
      ...
      let url = 'http://' + document.location.hostname + ':8081/get_rolled_steel_train/findByPage?';
    ...
    async deleteData(id){
      let url = 'http://' + document.location.hostname + ':8081/get_rolled_steel_train/deleteById?id=' + id;
