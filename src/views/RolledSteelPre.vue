<template>
  <el-form
    ...
    <el-breadcrumb separator-icon="ArrowRight">
      ...
      <el-breadcrumb-item>预测成材率</el-breadcrumb-item>
    </el-breadcrumb>
    <el-divider />
...
const submitForm = async (formEl: FormInstance | undefined) => {
  ...
  await formEl.validate(async (valid, fields) => {
    if (valid) {
      let url = 'http://' + document.location.hostname + ':8081/get_rolled_steel_test/addData';
      await axios.post(url, ruleForm).then(function (){
        ElMessage({
          message: '添加成功',
          center: true,
          type: 'success',
