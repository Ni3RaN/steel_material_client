...
export default {
  ...
  methods: {
    async getTotal(){
      let total;
      let url = 'http://' + document.location.hostname + ':8081/get_slab_steel_train/getPage';
    ...
    async getData() {
      ...
      let url = 'http://' + document.location.hostname + ':8081/get_slab_steel_train/findByPage?';
    ...
    async deleteData(id){
      let url = 'http://' + document.location.hostname + ':8081/get_slab_steel_train/deleteById?id=' + id;
